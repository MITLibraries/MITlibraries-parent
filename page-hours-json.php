...
?>
	...
	?>
		  <td data-day="<?php echo esc_attr( $i ); ?>" class="<?php echo esc_attr( $class ); ?>" data-foo="bar"><span class="hidden-non-mobile date-label"><?php echo esc_html( date( 'D', $curDay ) ) . '<br/>' . esc_html( date( 'n/j', $curDay ) ); ?></span></td>
		  <?php } ?>
		</tr>
		<?php wp_reset_postdata();
endwhile;    ?>
...
?>
		<td data-day="<?php echo esc_attr( $i ); ?>" class="<?php echo esc_attr( $class ); ?> noPadding"><span class="hidden-non-mobile date-label"><?php echo esc_html( date( 'D', $curDay ) ) . '<br/>' . esc_html( date( 'n/j', $curDay ) ); ?></span></td>
		<?php } ?>
	  </tr>
	   <?php wp_reset_postdata();  ?>
	  <?php endwhile;   ?>
