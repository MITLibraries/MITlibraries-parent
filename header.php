...
<body <?php body_class(); ?>>
	<div class="wrap-page">
		<header class="header-main flex-container group">
			...
			<a href="/search" class="link-site-search hidden-non-mobile"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12" height="16" viewBox="0 0 12 12" alt="search" class="icon-search">
