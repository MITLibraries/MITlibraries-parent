...
<nav id="nav-main" class="nav-main hidden-non-mobile" aria-hidden="true">
	<ul>
		<li><a href="/search" class="no-underline main-nav-link">Search</a></li>
		<li><a href="/hours" class="no-underline main-nav-link">Hours & locations</a></li>
		<li><a href="/borrow" class="no-underline main-nav-link">Borrow & request</a></li>
		<li><a href="/research-support" class="no-underline main-nav-link">Research support</a></li>
		<li><a href="/about" class="no-underline main-nav-link">About</a></li>
	</ul>
</nav>
