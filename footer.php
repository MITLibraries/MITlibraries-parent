...
?>
	...
	<footer class="footer-main flex-container">
		...
		<div class="identity flex-container">
			...
			<span class="hidden-text">MIT Libraries</span>
			</a>
			<div class="social flex-container">
				...
				<a href="//instagram.com/mitlibraries/" title="Instagram">
					<svg class="icon-social--instagram" viewBox="0 0 120 120" enable-background="new 0 0 120 120" xml:space="preserve">
<path id="Instagram_10_" fill="#FFFFFF" d="M95.1,103.9H24.9c-0.2,0-0.4-0.1-0.6-0.1c-3.9-0.5-7.1-3.4-8-7.2
	...
	c-2,0-3.6,1.6-3.6,3.6c0,2.7,0,5.5,0,8.2c0,0.4,0.1,0.8,0.2,1.2c0.5,1.5,1.8,2.4,3.5,2.4C84,38.7,85.3,38.7,86.7,38.7L86.7,38.7z"/>
</svg>
				</a>
