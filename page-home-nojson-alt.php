<?php 
/**
 * Template Name: Home Page - Alternate Integration Template
 *
 */
	get_header();
?>
	...
	<div class="content-main flex-container">
		...
		<?php
			...
			// Build list of front page items
			if (mt_rand(0,1)) {
			...
			} // end building list of front page items

			// Render front page items
			...
			} // End rendering front page items
