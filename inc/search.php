...
<div id="search-main" class="search--lib-resources flex-container">
	<form id="site-search" method="get" action="https://mit-bento.herokuapp.com/search/bento">
		<h2><label for="mitlib-searchtext">Search for</label></h2>
		<input type="text" class="option-7 bento" placeholder="ex: Janet Mock, titanium skeleton, library hours" name="q" id="mitlib-searchtext"><button type="submit"><span class="visually-hidden">search</span><!-- per accessibility review/to be clipped via CSS -->
